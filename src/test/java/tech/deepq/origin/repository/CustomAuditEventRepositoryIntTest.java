package tech.deepq.origin.repository;

import tech.deepq.origin.JhipsterApp;
import tech.deepq.origin.config.Constants;
import tech.deepq.origin.config.audit.AuditEventConverter;
import tech.deepq.origin.domain.PersistentAuditEvent;
...
import static tech.deepq.origin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
